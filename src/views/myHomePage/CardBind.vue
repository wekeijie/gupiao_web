...
const create = () => {
  if (
    ...
    userInfor.value.bank_name == "" &&
    userInfor.value.bank_code == ""
  ) {
  ...
  store
    .dispatch("bank/create", {
      user_name: userInfor.value.name,
      bank_name: userInfor.value.bank_name,
      code: userInfor.value.bank_code,
