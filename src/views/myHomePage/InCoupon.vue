    ...
    <div class="grayBackgroud" style="min-height: 100lvh;">
            ...
            <div class="apply-box flexBetween">
                <div class="head-left flexStart" @click="goRouter('/SetInfor')">
                    ...
                    <div class="user-infor">
                        <h2>已累计签到 <span>7</span> 天</h2>
                        <h3 class="flexBetween">累计获得 <span>18.00</span>元利息
                        </h3>
                    </div>

                </div>
                <div class="sign-in-box" @click="isPop = !isPop" :class="isPop ? 'isSigned' : 'noSigned'">

                    立即签到
                </div>

            </div>
            <div class="head-bottom">利息劵ID：</div>
        </div>
        ...
        <div class="rule_box">
            ...
            <p style="position: relative;">
                ...
                当月连续签到10天,额外奖励利息券29元<br> 当月连续签到20天,额外奖励利息券59元<br> 当月连续签到满月,额外奖励利息券99元
            </p>
        </div>

        <v-overlay v-model="isPop" class="align-center justify-center " @click="isPop = false">
            <div class="pop_box">
                <p>利息捐 +2元</p>
            </div>
        </v-overlay>
