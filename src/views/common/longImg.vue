<template>
    <div>
        ...
        <div class="rich-cont-box">
            <img src="../../assets/img/longPicture/beginner.jpg" v-if="srcImg == '1'">
            <img src="../../assets/img/longPicture/InviteRewards.jpg" v-if="srcImg == '2'">
            <img src="../../assets/img/longPicture/FollowRule.png" v-if="srcImg == '3'">
        </div>
...
onMounted(
    () => {
        ...
        if ($route.query.srcImg) srcImg.value = $route.query.srcImg
    }
)
</script>
